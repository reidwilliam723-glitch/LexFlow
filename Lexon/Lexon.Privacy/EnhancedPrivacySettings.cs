...
public class EnhancedPrivacySettings : UserControl
{
    ...
    private void InitializeComponent()
    {
        ...
        {
            Text = "Configure how Lexon handles your data and privacy. Learn more about each setting below.",
    ...
    private List<PrivacySetting> GetPrivacySettings()
    {
        return new List<PrivacySetting>
        {
            new PrivacySetting
            {
                ...
                Explanation = "When enabled, Lexon will only use local suggestion sources (dictionary, learned patterns). AI features will be disabled. This provides maximum privacy but may reduce suggestion quality.",
                Enabled = false,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "Lexon uses window class names and UI patterns to identify secure fields. Suggestions are automatically blocked in these contexts to prevent accidental data exposure.",
                Enabled = true,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "You can specify applications where Lexon should never show suggestions. This is useful for apps that handle sensitive information.",
                Enabled = true,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "Lexon learns from your typing patterns to improve suggestions. You can choose how long to retain this data. Shorter retention periods improve privacy but may reduce suggestion accuracy.",
                Enabled = true,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "All data stored by Lexon is encrypted using military-grade AES-GCM encryption. The encryption key is protected by Windows DPAPI, which ties it to your user account.",
                Enabled = true,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "Keep a detailed log of when suggestions were requested, which applications made requests, and what data was processed. This helps you monitor Lexon's activity.",
                Enabled = false,
            ...
            new PrivacySetting
            {
                ...
                Explanation = "When using cloud AI features, Lexon can strip personally identifiable information before sending data. This reduces privacy risks when using AI suggestions.",
                Enabled = true,
