...
public class SystemTrayManager : IDisposable
{
    ...
    private void InitializeTrayIcon()
    {
        ...
        var toggleMenuItem = new ToolStripMenuItem("Enable Lexon");
    ...
    public void SetStatus(ServiceStatus status, string? additionalInfo = null)
    {
        ...
        var tooltipText = $"Lexon {AppVersion.Current} - {statusText}";
        ...
        {
            toggleMenuItem.Text = status == ServiceStatus.Active ? "Disable Lexon" : "Enable Lexon";
        }
    }
