...
public class WritingStatsForm : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        var intro = new Label
        {
            Text = "Totals Lexon has helped with — opened from Settings whenever you want to look.",
            AutoSize = true,
        ...
        _unavailable.Text = "Statistics are available only while Lexon is running.";
