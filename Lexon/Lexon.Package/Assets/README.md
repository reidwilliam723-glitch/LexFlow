...
### Application Icon
- **Lexon.ico** - Main application icon (256x256 with 16x16, 32x32, 48x48, 64x64, 128x128, 256x256)

## Design Guidelines

### Icon Style
- Modern, clean design
- Use the "L" letter or abbreviation for Lexon
...
After adding icons:
1. Build the package: `dotnet build Lexon.Package`
