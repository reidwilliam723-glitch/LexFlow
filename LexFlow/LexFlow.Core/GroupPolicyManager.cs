...
{
    private const string PolicyRegistryPath = @"SOFTWARE\Policies\LexFlow";
    private const string AIPolicyPath = @"SOFTWARE\Policies\LexFlow\AI";
    private const string PrivacyPolicyPath = @"SOFTWARE\Policies\LexFlow\Privacy";
    private const string BlockedAppsPath = @"SOFTWARE\Policies\LexFlow\BlockedApps";
    private const string LicensingPath = @"SOFTWARE\LexFlow\Licensing";
