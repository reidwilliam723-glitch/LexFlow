...
public class UpdateManager
{
    ...
    public UpdateManager()
        : this(new HttpClient { Timeout = TimeSpan.FromSeconds(30) }, GetApplicationVersion(), "https://lexflow.com/updates")
    {
    }
    ...
    public UpdateManager(HttpClient httpClient, string currentVersion, string updateServerUrl)
    {
        ...
        _updateServerUrl = string.IsNullOrWhiteSpace(updateServerUrl) ? "https://lexflow.com/updates" : updateServerUrl.TrimEnd('/');
