...
public partial class OnboardingWizard : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.Text = "Welcome to LexFlow - Setup Wizard";
    ...
    private async Task CompleteOnboardingAsync()
    {
        ...
        MessageBox.Show("Setup complete! LexFlow is now configured for your needs.", "Welcome to LexFlow", MessageBoxButtons.OK, MessageBoxIcon.Information);
...
public class WelcomeStep : WizardStep
{
    public override void Initialize(Panel panel, OnboardingState state)
    {
        ...
        stack.Controls.Add(WizardLayout.Title("Welcome to LexFlow!", size: 20f, bottomMargin: 30));
        stack.Controls.Add(WizardLayout.Body(
            "LexFlow is your intelligent typing assistant that learns your writing style and provides smart suggestions across all your applications.\n\nThis wizard will help you configure LexFlow to match your needs."));
        stack.Controls.Add(WizardLayout.Body(
...
public class PrivacyDisclosureStep : WizardStep
{
    ...
    {
        var stack = WizardLayout.CreateStack();
        stack.Controls.Add(WizardLayout.Title("What LexFlow can see — and what leaves your PC"));
        stack.Controls.Add(WizardLayout.Body(
            "LexFlow watches the field you are typing in so it can offer local suggestions. That includes the words around the caret in the focused app.\n\n" +
            ...
            "Double-press Ctrl at any time to fully disable LexFlow until you turn it back on.",
...
public class ProfileSelectionStep : WizardStep
{
    ...
    public override void Initialize(Panel panel, OnboardingState state)
    {
        ...
        stack.Controls.Add(WizardLayout.Body(
            "Select a profile that best matches how you'll use LexFlow. You can customize this later."));
...
public class CompletionStep : WizardStep
{
    public override void Initialize(Panel panel, OnboardingState state)
    {
        ...
        stack.Controls.Add(WizardLayout.Title(
            ...
            bottomMargin: 30));
        stack.Controls.Add(WizardLayout.Body(
            $"LexFlow has been configured with the {state.SelectedProfile} profile.\n\nYou can always adjust these settings later by right-clicking the LexFlow icon in your system tray and selecting Settings."));
        stack.Controls.Add(WizardLayout.Body(
            "Quick Tips:\n• Press Tab to accept a suggestion\n• Press Esc to dismiss suggestions\n• Double-press Ctrl to quickly disable/enable LexFlow\n• Right-click the system tray icon for quick access to settings",
