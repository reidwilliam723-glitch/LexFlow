...
/// <summary>
/// Shared composition logic for building LexFlowService and its dependencies.
/// Used by both console service and WinForms tray app entry points to ensure
/// consistent wiring and avoid divergence.
/// </summary>
public static class LexFlowServiceComposer
{
    /// <summary>
    /// Result of building the LexFlow service composition
    /// </summary>
    public class CompositionResult
    {
        public LexFlowService Service { get; set; } = null!;
    ...
    /// <summary>
    /// Builds the complete LexFlow service composition with all dependencies wired.
    /// </summary>
    public static async Task<CompositionResult> BuildAsync()
    {
        ...
        keyboardShortcutManager.RegisterShortcut("UndoLexFlow", new KeyboardShortcut
        {
            Key = 0x5A, // Z
        ...
        // Create and wire LexFlow service
        var lexFlowService = new LexFlowService(
            suggestionPipeline,
            keyboardListener,
            focusTracker,
            suggestionOverlay,
        ...
        lexFlowService.AttachWritingEnhancement(selectionRewrite, grammarCheck, mouseListener);
    ...
    private static void InitializeUpdateManager(Profile profile)
    {
        try
        {
            ...
            var updateServer = profile.GetSetting("UpdateServer", "https://lexflow.com/updates");
