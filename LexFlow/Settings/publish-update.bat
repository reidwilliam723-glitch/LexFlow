@echo off
REM Double-click this file to build, pack, and publish a LexFlow release.
REM Bump <Version> in LexFlow.Settings\LexFlow.Settings.csproj BEFORE running this,
